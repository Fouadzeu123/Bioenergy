<x-layouts :title="'Dashboard'">
    ...
    <div class="max-w-xl mx-auto pt-5 px-4 space-y-6">
        ...
        <!-- Carousel Premium -->
        <div class="relative rounded-[2rem] overflow-hidden shadow-2xl aspect-video group"
            style="border: 1px solid rgba(255,255,255,0.08); background: #07090f;">
            <div id="carousel" class="flex h-full transition-transform duration-700 cubic-bezier(0.4, 0, 0.2, 1)">
                <img src="{{ asset('images/slide1.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide2.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide3.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide4.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide5.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide6.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide7.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide8.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide9.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
                <img src="{{ asset('images/slide10.jpg') }}" class="w-full h-full object-cover flex-shrink-0 select-none">
            </div>
            
            <!-- Overlay Soft -->
            <div class="absolute inset-0 pointer-events-none" 
                style="background: linear-gradient(to top, rgba(7,9,15,0.6) 0%, transparent 40%);">
            </div>
            
            <!-- Dynamic Indicators -->
            <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 px-3 py-1.5 rounded-full backdrop-blur-md bg-black/30 border border-white/10" id="carousel-dots">
                <!-- Dots generated by JS -->
            </div>

            <!-- Subtle side shadows -->
            <div class="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-black/20 to-transparent pointer-events-none"></div>
            <div class="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-black/20 to-transparent pointer-events-none"></div>
        </div>
    ...
    <script>
        ...
        slides.forEach((_, i) => {
            ...
            dot.className = `h-1 rounded-full transition-all duration-500 ${i === 0 ? 'w-4 bg-white' : 'w-1 bg-white/40'}`;
        ...
        function slideTo(idx) {
            ...
            dots.forEach((dot, i) => {
                if (i === index) {
                    dot.classList.replace('w-1', 'w-4');
                    dot.classList.replace('bg-white/40', 'bg-white');
                } else {
                    dot.classList.replace('w-4', 'w-1');
                    dot.classList.replace('bg-white', 'bg-white/40');
                }
            });
        }

        let autoSlide = setInterval(() => slideTo(index + 1), 5000);
        ...
        carousel.addEventListener('touchend', (e) => {
            ...
            autoSlide = setInterval(() => slideTo(index + 1), 5000);
        }, {passive: true});
