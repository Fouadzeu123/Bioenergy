...
<!-- Modal Produit -->
<div id="productModal" class="fixed inset-0 z-[110] hidden flex items-center justify-center backdrop-blur-sm p-4" style="background: rgba(0,0,0,0.75);">
    <div class="rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden animate__animated animate__slideInUp" style="background: #0d1117; border: 1px solid rgba(255,255,255,0.08);">
        <div class="relative h-44">
